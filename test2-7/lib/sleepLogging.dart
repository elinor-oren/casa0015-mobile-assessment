            ...
            children: <Widget>[
              ...
              ElevatedButton(
                onPressed: () {
                  ...
                  int durationHours = _intervalBedTime.h;
                  int durationMinutes = _intervalBedTime.m;

                  // Directly use HealthSessionData to set sleep duration
                  HealthSessionData()
                      .setSleepDuration(durationHours, durationMinutes);
                  HealthSessionData().printData(); // Print data here

                  // Navigate to the PPG page after setting the sleep duration
                  Navigator.pushNamed(context, '/ppg');
                },
